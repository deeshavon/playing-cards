...
public class Trick {
  ...
  private final List< Card > blackPile;  //lines 8-9 are the fields
  private final List< Card > redPile;

  public Trick(
      Random rng) { //this where we start setting the constructors below, in the next few lines.
    this.rng = rng;
    Deck deck = new Deck();
    deck.shuffle(rng);
    blackPile = new ArrayList<>(); //arraylist is best because we are sorting the cards, per Nick
  ...
  public static void main(
      String[] args) { //this line is the beginning of the method (at the left curly brace)
    ...
    // TODO: 9/28/22 swap a random # of cards (between 0 and the size of the smaller pile, inclusive) between red and black piles.
    // TODO: 9/28/22 tally the results: count red cards in red pile, black cards in black pile, compare for equality; also, dislplay the contents of the piles.

  }

  private void swapBetweenPiles() { //this is the swap method
